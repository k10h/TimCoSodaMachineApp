...
namespace SodaMachineLibrary.Test.Mocks
{
    public class MockDataAccess : IDataAccess
    {
        ...
        public Dictionary<string, decimal> UserCredit { get; set; } = new Dictionary<string, decimal>(); //UserId, Amount
        ...
        public decimal MachineInfo_EmptyCash()
        {
            ...
            decimal output = value.cashOnHand;
            value.cashOnHand = 0;
            MachineInfo = value;
        ...
        public SodaModel SodaInventory_WithdrawSoda(SodaModel soda)
        {
